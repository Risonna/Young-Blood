...
Чтобы скомпилировать проект, необходимо установить renpy [отсюда](https://www.renpy.org/latest.html), затем закинуть папку MAINPROJECT из данного репозитория в папку с проектами renpy(можно изменить путь в настройках), а затем перезапустить renpy. В окошке проектов появится вкладка MAINPROJECT. Чтобы скомпилировать проект, требуется нажать Построить дистрибутивы в нижнем правом углу главного окна renpy. Затем выбрать предпочтения и нажать кнопку построить
